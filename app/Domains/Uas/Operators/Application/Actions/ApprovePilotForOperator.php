...
class ApprovePilotForOperator
{
 ...
 public function suspend(UasOperatorPilot $assignment,User $actor): UasOperatorPilot { return $this->transition($assignment,'suspended',$actor); }
 ...
 public function end(UasOperatorPilot $assignment,User $actor): UasOperatorPilot { return $this->transition($assignment,'ended',$actor); }
