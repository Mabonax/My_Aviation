...
class StoreOperatorProfileRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('create', UasOperator::class) ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'registration_number' => ['nullable', 'string', 'max:120', 'unique:uas_operators,registration_number'],
            'uasoc_number' => ['nullable', 'string', 'max:120', 'unique:uas_operators,uasoc_number'],
