...
{
    protected $fillable = ['uas_aircraft_id', 'uas_pilot_id', 'flight_date', 'folio_reference', 'flight_hours', 'battery_cycles', 'charging_fuel_oil_records', 'maintenance_certification_entries', 'defects_reported', 'available_offline', 'evidence_references'];
