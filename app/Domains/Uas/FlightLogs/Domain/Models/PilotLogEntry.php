...
{
    protected $fillable = ['uas_pilot_id', 'flight_date', 'aircraft_registration', 'operation_type', 'flight_hours', 'launch_location', 'landing_location', 'remarks', 'evidence_references'];
