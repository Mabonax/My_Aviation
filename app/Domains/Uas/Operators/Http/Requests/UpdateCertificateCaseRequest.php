...
class UpdateCertificateCaseRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('update', $this->route('certificateCase')->operator) ?? false;
    }

    public function rules(): array
    {
        return [
            'case_number' => ['nullable', 'string', 'max:80', Rule::unique('uas_operator_certificate_cases', 'case_number')->ignore($this->route('certificateCase'))],
