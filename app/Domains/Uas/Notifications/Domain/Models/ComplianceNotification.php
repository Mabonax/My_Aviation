...
{
    protected $fillable = ['user_id', 'notifiable_record_type', 'notifiable_record_id', 'requirement_id', 'notification_type', 'channel', 'status', 'subject', 'message', 'due_at', 'sent_at'];

    protected function casts(): array
    {
        return ['due_at' => 'datetime', 'sent_at' => 'datetime'];
    }
