...
class RegulatoryRequirementPolicy
{
    public function viewAny(User $user): bool { return $this->hasPermission($user, 'regulations.view'); }
    public function view(User $user, RegulatoryRequirement $requirement): bool { return $this->hasPermission($user, 'regulations.view'); }
    public function create(User $user): bool { return $this->hasPermission($user, 'regulations.create'); }
    public function update(User $user, RegulatoryRequirement $requirement): bool { return $this->hasPermission($user, 'regulations.update'); }
    public function delete(User $user, RegulatoryRequirement $requirement): bool { return false; }
